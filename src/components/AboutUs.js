...
<div className="container col-12">
        <div className="container-fluid border-dark bg-dark">
          <div className="container col-4">
              <h1 className="col-10 text-left "className="text-light">About Us</h1>
          </div>
        </div>
     </div>
...
Topic wise tests and combined tests are conducted regularly to judge the preparation of the students. Tests and course covered are perfectly coordinated. These tests work as real shield to counter the final examination the students aspire for. Our combined tests are very systematically mixed with topic wise tests and develops a very strong competitive spirit among the students, which motivates them to forge ahead in order to achieve their goal.
            </div>
    </>
