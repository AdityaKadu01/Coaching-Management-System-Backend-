...
useEffect (() =>{ 
    ...
    return (
        <div>
            ...
            <br />
            <br />
            <button style={{marginTop: "9px", marginLeft: "25px"}} className="btn btn-secondary" >View Profile</button>
            <button style={{marginTop: "9px", marginLeft: "25px"}} className="btn btn-secondary" >View Course</button>
